...
public interface Constant {
    ...
    * 微信相关
    ...
    // 你的appid
    public static final String WX_LOGIN_APPID = "wx1******06e";
    // 你的密匙
    public static final String WX_LOGIN_SECRET = "d4cf81e******82e6b5e";
    // 固定参数
    ...
    *  图灵机器人
    ...
    //apikey
    public static final String REBOOT_KEY = "469f61*****7c11ece";

    //百度地图
    public static final String BAIDU_MAP_TO = "http://api.map.baidu.com/geocoding/v3/";
    public static final String BAIDU_MAP_AK = "qimDW*****lwUj8S";
